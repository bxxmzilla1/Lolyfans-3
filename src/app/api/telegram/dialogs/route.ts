...
export async function GET() {
  ...
  try {
    ...
    // Reaction-to-pay scanning runs in the cron worker
    // (/api/telegram/reactions/scan) — not here, where the short function
    // window would kill long video deliveries mid-upload.
