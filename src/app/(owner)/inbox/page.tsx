    ...
    <>
      ...
      <div className="hidden lg:flex h-full flex-col items-center justify-center gap-4 text-center p-8">
        ...
        <p className="text-muted text-sm max-w-xs">
          Select a Telegram channel on the left. To sell Stars PPVs, message
          your bot on Telegram — it turns photos and videos into forwardable
          invoices.
        </p>
      </div>
    </>
