    ...
    <div className="space-y-6 max-w-lg">
      <div>
        ...
        <p className="text-xs text-muted mt-1 leading-relaxed">
          ...
          blurred edge-to-edge with a card that reads{" "}
          <b>Users must verify their card to watch free content</b>. Tapping
          it opens the
        ...
        <div className="relative w-64 h-44 rounded-3xl overflow-hidden bg-gradient-to-br from-accent/40 via-card2 to-accent/20 border border-line">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-5">
            <span className="flex flex-col items-center gap-2 rounded-3xl bg-gradient-to-b from-accent to-sky-600 px-5 py-4 shadow-2xl shadow-sky-900/40 ring-1 ring-white/30">
              ...
              <span className="text-white text-xs font-bold text-center leading-snug max-w-[180px] drop-shadow">
                Users must verify their card to watch free content
              </span>
              <span className="text-white/90 text-[10px] font-semibold drop-shadow">
                Tap here to verify
              </span>
            </span>
          </div>
