...
/**
 * Guest sign-up: email + password only. After join, open the creator's
 * Telegram channel when configured, otherwise the fan home feed.
 */
  ...
  return (
    <>
      <form onSubmit={join} className="w-full flex flex-col gap-3">
        ...
        >
          {busy ? "Signing up…" : buttonText?.trim() || "Join the channel"}
        </button>
      </form>
